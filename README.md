...
This project comprises basic web content for a blog on the history of paperwork for the period 1800-1950. It aims to develop into a collaborative, international, 
and peer-reviewed blog that brings together for the first time scholarship on paperwork – all documents produced in response to a demand (real or imagined) by 
an office, the law, a lab, or similar organizational entity. 



Historical scholarship in the field of history of (bureaucratic) 
...
this scholarship under the label of **"the history of paperwork"**

aims to get people inside and outside the academy thinking about paperwork in the past and in the present


I envision this to be less about topics covered by art & literary history than to facilitate deeper discussions among librarians, historians, curators, & 
archivists around all aspects of pre-electric data management

oriented toward practical, rather than literary ends

focus should be on 19th/20th mass-scale information systems in
 comprising technologies that now have become the iconic repertoire from which graphical computer interfaces are assembled: forms, manila folder, keyboard, filing cabinets, 
 as not least this project tesitifies.


bringing together scholarship  // to facilitate deeper discussions among librarians, historians, curators, & archivists 
around all aspects of pre-electric data management & material cultures involved // to form research network and prepare larger funding bid // help consolidate history of paperwork as an identifiable subfield.

This process of professionalization—the shift from blogging as a hobby to a line on your CV—is not unique to Nursing Clio. Over the past several years, 
collaboratively produced history blogs have blossomed into popular venues that give current historical scholarship an accessible public face. They have grown rapidly, 
formalized their editorial procedures into those of small publications, and recruited new historians to join their ranks of writers and editors.

Apart from science communication, this blog will help contributors to habitualize their writing practices which is crucial for succesful science communication and ordering throughts  

## UX ##

 
Since 2016, I have been carving out my niche in this scholarly field of paperwork history and promoted scholarship on twitter under the *#histpaperwork* hashtag,
viz. short for 'history of paperwork'. So the idea for this blog predates my enrolment at CI, yet upon studying the course material I have carried with me the idea of using Milestone Project 1 to have a first shot
...
The reference to 'files' in the title is not a bad choice in the end, as it allows us to immediately point readership to the main focus of this blog: the file as 
arguably the most basic unit of paperwork in its more standardized formats - an idea which neither 'paper tales' nor 'paper trails' convey in the same manner, 
...
[second call](https://twitter.com/jochenfm/status/1279396434635370496) on July 4. I added a 
...
In response to my call on April 28, I also received a number of 
suggestions from colleagues of how to improve on the initial ideas and what else to include in this blog, such as a bibliography to gather pertinent literature 
in one place online.
